...
def main():
    ...
    args = ap.parse_args()
    # Only --live may reach the network. Without it the run replays, which is
    # what the README promises and what keeps --dry-run genuinely write-free:
    # a live turn records a transcript file as a side effect.
