...
# GDD story bible: the dog is never named, the kid called her "girl", and the
# robot is a REX-line unit. The grid uses those words rather than initials so
# a first-time player does not have to decode a legend before moving.
CELL = 5
...
def draw(g):
    ...
    print("  girl is you. REX is the robot. kid is where you are going.")
...
def intro(g):
    ...
    print("=" * 62)
    print("You are the dog. You have no name; the kid called you girl.")
    print("A REX-line robot is hunting you across a %dx%d yard."
          % (g.phase.width, g.phase.height))
    print("Stand on the kid's tile before round %d and before stamina" % MAX_ROUNDS)
